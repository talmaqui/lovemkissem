...
NOTE: The Lovem Kissem website is down right now because I'm no longer a Github PRO user. I'm taking this as a golden opportunity to redesign the website and to redo my tutorial for adding it to Visual Studio Code. But if you wanted to use it, I have included a new file (the Lovem Kissem PDF) or you can copy the text directly from this repository instead.
...
# ❤️️ bonus!❤️️
i added lovem kissem to Visual Studio Code as its own snippet! you can watch or read how to do it on the website soon (i need to upload the tutorial for adding it to VSCode), and then you just type in 'love' + ENTER or RETURN to get a lovem kissem paragraph! ❤️️

second bonus: will show ya how to make your own lorem ipsum this way if you want. (:
